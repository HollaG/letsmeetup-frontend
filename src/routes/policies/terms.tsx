    ...
    return (
        <Stack>
            ...
            <Text>
                ...
                the use of Look4Times's Website, located at look4times.com.
            </Text>

            <Text>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Look4Times if you do not
            ...
            <Text>
                ...
                and subject to, prevailing law of sg. Any use of the above
            ...
            <Text>
                We employ the use of cookies. By accessing Look4Times, you
                agreed to use cookies in agreement with the Look4Times's Privacy
                Policy.{" "}
            </Text>
            ...
            <Text>
                Unless otherwise stated, Look4Times and/or its licensors own the
                intellectual property rights for all material on Look4Times. All
                intellectual property rights are reserved. You may access this
                from Look4Times for your own personal use subjected to
                restrictions set in these terms and conditions.
            </Text>

            <Text>You must not:</Text>
            <ul>
                <li>Republish material from Look4Times</li>
                <li>Sell, rent or sub-license material from Look4Times</li>
                <li>Reproduce, duplicate or copy material from Look4Times</li>
                <li>Redistribute content from Look4Times</li>
            </ul>
            ...
            <Text>
                ...
                website. Look4Times does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Look4Times,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Look4Times shall not be liable for
            ...
            <Text>
                Look4Times reserves the right to monitor all Comments and to
            ...
            <Text>
                You hereby grant Look4Times a non-exclusive license to use,
            ...
            <Text>
                ...
                of Look4Times; and (d) the link is in the context of general
            ...
            <Text>
                ...
                by sending an e-mail to Look4Times. Please include your name,
            ...
            <Text>
                No use of Look4Times's logo or other artwork will be allowed for
